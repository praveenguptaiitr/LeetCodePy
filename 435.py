...
class Solution(object):
    ...
    def eraseOverlapIntervals(self, intervals):
        ...
        intervals.sort(key=cmp_to_key(cmp_items))
        i = 0
        count = 0
        end = intervals[0].end
...
if __name__ == "__main__":
    ...
    print(s.eraseOverlapIntervals([Interval(1,2),Interval(2,3),Interval(3,4),Interval(1,3)]))
    print(s.eraseOverlapIntervals([Interval(1, 2), Interval(1,2), Interval(1,2)]))
    print(s.eraseOverlapIntervals([Interval(1, 2), Interval(2,3)]))
